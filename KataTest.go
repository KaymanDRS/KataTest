...
const (
	errorMath         = "Ошибка!!! Строка не является математической операцией."
	errorOperators    = "Ошибка!!! Формат математической операции не удовлетворяет заданию — два операнда и один оператор (+, -, /, *)."
	errorNumberSystem = "Ошибка!!! Одновременно используются разные системы счисления."
	errorRome         = "Ошибка!!! В римской системе нет отрицательных чисел."
	errorRomeZero     = "Ошибка!!! В римской системе нет числа 0."
	errorRange        = "Ошибка!!! Калькулятор умеет работать только с арабскими целыми числами или римскими цифрами от 1 до 10 включительно"
)
...
func main() {
	fmt.Println("Привет! Введи выражение:")
